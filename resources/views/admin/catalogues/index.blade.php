                            ...
                            @foreach ($data as $item)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <img src="{{ $url }}" alt="" width="100px" height="100">
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{route('admin.catalogues.show', $item->id)}}" class="btn btn-primary mx-2">Xem</a>
                                            <a href="{{route('admin.catalogues.edit', $item->id)}}" class="btn btn-warning me-2">Sửa</a>
